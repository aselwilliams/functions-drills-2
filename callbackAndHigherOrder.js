...
// CODE HERE
const multiply = (num1, num2, execute) => {
  return execute(num1 * num2)
}
...
// CODE HERE
const last = (array, lastOne) => {
  return lastOne(array[array.length-1])
}
...
// const contains = (arr, str, callback) => arr.includes(str) ? callback(true) : callback(false)
...
// CODE HERE
uniq(names, callbackFn) 

function callbackFn(uniqArr){
...
const each = (arr, callback) => {
  arr.forEach((el, i)=> callback(el, i))
}
